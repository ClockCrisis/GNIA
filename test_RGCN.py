...
sys.path.append('..')
from utils import *
from model import oriRGCN, num_decoder, cat_decoder, BotRGCN, encoder, num_encoder, RGCN_weight
...
def main(opts):
    ...
    detect_model = BotRGCN().to(device)
    detect_model.load_state_dict(torch.load('./processed_data/model_RGCN.pth', map_location='cpu'))
