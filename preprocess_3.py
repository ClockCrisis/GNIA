...
# node=pd.read_json("./dataset/cresci-2015/node.json")
...
# torch.save(num_properties_tensor,path+'num_properties.pt')
# print(num_properties_tensor)
#


#缺失的数据手动填上了
followers_count_mean = 246.0
followers_count_std = 5879.0
active_days_mean = 3201.0
active_days_std = 461.0
screen_name_length_mean = 11.0
screen_name_length_std = 3.0
following_count_mean = 386.0
following_count_std = 561.0
statues_mean = 3.0
statues_std = 25.0
